...
export const metadata: Metadata = {
  ...
  description: "AWS, GCP, and Azure architecture, IaC with Terraform, CI/CD pipelines, and cost-optimised cloud deployments.",
};
...
export default function ServicePage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-tln-text">
      ...
      <p className="text-tln-muted text-lg mb-12 max-w-2xl">AWS, GCP, and Azure architecture, IaC with Terraform, CI/CD pipelines, and cost-optimised cloud deployments.</p>
