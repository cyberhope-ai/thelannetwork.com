...
export const metadata: Metadata = {
  ...
  description: "Ongoing platform reliability, monitoring, incident response, and feature delivery under a predictable monthly retainer.",
};
...
export default function ServicePage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-tln-text">
      ...
      <p className="text-tln-muted text-lg mb-12 max-w-2xl">Ongoing platform reliability, monitoring, incident response, and feature delivery under a predictable monthly retainer.</p>
