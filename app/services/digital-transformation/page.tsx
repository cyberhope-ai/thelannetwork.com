...
export const metadata: Metadata = {
  ...
  description: "Legacy modernisation, process automation, and technology roadmapping to move your organisation into the next decade.",
};
...
export default function ServicePage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-tln-text">
      ...
      <p className="text-tln-muted text-lg mb-12 max-w-2xl">Legacy modernisation, process automation, and technology roadmapping to move your organisation into the next decade.</p>
