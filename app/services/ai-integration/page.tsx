...
export const metadata: Metadata = {
  ...
  description: "End-to-end AI feature integration — LLMs, RAG pipelines, vector databases, and governed agent workflows for your existing products.",
};
...
export default function ServicePage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-tln-text">
      ...
      <p className="text-tln-muted text-lg mb-12 max-w-2xl">End-to-end AI feature integration — LLMs, RAG pipelines, vector databases, and governed agent workflows for your existing products.</p>
