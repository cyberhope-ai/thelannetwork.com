...
export const metadata: Metadata = {
  ...
  description: "React Native, Flutter, and native iOS/Android apps built to production standards with human-led AI delivery.",
};
...
export default function ServicePage() {
  return (
    <main className="max-w-5xl mx-auto px-6 py-16 text-tln-text">
      ...
      <p className="text-tln-muted text-lg mb-12 max-w-2xl">React Native, Flutter, and native iOS/Android apps built to production standards with human-led AI delivery.</p>
